 ...
 * optional ui_key string The key used for remembering window geometry.
 * optional ui datum/tgui The UI to be updated, if it exists.
 * optional force_open bool If the UI should be re-opened instead of updated.
 * optional master_ui datum/tgui The UI which owns this UI, if any.
 * optional state datum/ui_state The state to use for this UI.
 */
/datum/proc/ui_interact(mob/user, ui_key = "main", datum/tgui/ui = null, force_open = FALSE, datum/tgui/master_ui = null, datum/ui_state/state = null)
