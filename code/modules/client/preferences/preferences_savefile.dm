...
/datum/preferences/proc/load_preferences()
	...
	tgui_pref = sanitize_integer(tgui_pref, 0, 1, initial(tgui_pref))
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["tgui_pref"], tgui_pref)
...
/datum/preferences/proc/load_character(slot)
	...
	if(!is_valid_headshot_link(null, ooc_extra, TRUE, list("mp3")))
		ooc_extra = null
